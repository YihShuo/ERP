...
public class iqcdefect extends AbstractMainActivity implements OnItemSelectedListener {
	...
	private void SaveDefectData(){
		...
		if(RYlist_index>-1){
			...
			String jsonData="{\"Defect\":{\"Order\":\""+RYlist.ID.get(RYlist_index)+"\",\"DepID\":\""+Deplist.ID.get(Deplist_index)+"\",\"GXLB\":\""+Stagelist.Value.get(Stagelist_index)+"\",\"Qty\":\""+Qty_Edit.getText()+"\",\"NG\":\""+NG_Edit.getText()+"\",\"Data\":[";
