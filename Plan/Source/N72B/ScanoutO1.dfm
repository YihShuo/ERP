object ScanoutO: TScanoutO
  ...
  object ScanData: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT distinct c.DDBH, d.XieMing, c.XXCC, a.QtyIn,a.QtyOut,a.Qt' +
        'yin - ISNULL(a.qtyout, 0) AS TonKho,a.Codebar,a.Ma_Ke,a.ID'
      'FROM SMZL_MAKE A '
      'LEFT JOIN smddss C ON a.CODEBAR = c.CODEBAR '
      'LEFT JOIN smdd D ON c.DDBH = d.DDBH '
      'WHERE okCTS > 0 '
      'AND c.GXLB = '#39'O'#39' '
      'AND c.DDBH LIKE '#39'%JHS2504-755%'#39' '
