object ExtraDel_Print: TExtraDel_Print
  Left = 451
  Top = 217
  Width = 1192
  Height = 625
  Caption = 'ExtraDel_Print'
  Color = clBtnFace
  ...
  object DelTot: TQuery
    ...
    SQL.Strings = (
      'select  KCLLS.CLBH,CLZL.YWPM,CLZL.ZWPM,CLZL.DWBH'
        ...
        '         ,sum(tempQty) as Qty,convert(varchar(250),'#39#39') as MEMO,K' +
        'CLLS.MEMO as MEMO1'
      'from KCLLS'
      'left join CLZL on CLZL.CLDH=KCLLS.CLBH'
      'where KCLLS.LLNO=:LLNO'
      'group by KCLLS.CLBH,CLZL.YWPM,CLZL.ZWPM,CLZL.DWBH,KCLLS.MEMO')
    ...
    object DelTotMEMO: TStringField
      FieldName = 'MEMO'
      FixedChar = True
      Size = 250
    end
    object DelTotMEMO1: TStringField
      FieldName = 'MEMO1'
      FixedChar = True
      Size = 250
    end
