object ReturnMaterial: TReturnMaterial
  Left = 244
  Top = 105
  Width = 1105
  Height = 570
  Caption = 'ReturnMaterial'
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
        ...
        'KCLLS.Qty,KCLLS.USPrice,KCLLS.VNPrice,KCLLS.CWHL'
      
        '       ,KCLLS.CostID,KCLLS.UserDate,KCLLS.UserID,KCLLS.YN,KCLLS.' +
        'CLSL,KCLLS.YYBH,KCLLS.BLSB,KCLLS.CWSB,KCLLS.VNACC,KCLLS.Memo'
      '       ,CLZL.YWPM,CLZL.DWBH,SCBLYY.YWSM,SCBLYY.ZWSM,CLZL.ZWPM'
      'from KCLLS'
    ...
    object DelDetCWSB: TStringField
      FieldName = 'CWSB'
      FixedChar = True
      Size = 1
    end
  ...
  object DelMas: TQuery
    ...
    object DelMasSEASON: TStringField
      FieldName = 'SEASON'
      Origin = 'DB.KCLL.SEASON'
      FixedChar = True
      Size = 10
    end
    object DelMasDEVTYPE: TStringField
      FieldName = 'DEVTYPE'
      Origin = 'DB.KCLL.DEVTYPE'
      FixedChar = True
    end
    object DelMasPURPOSE: TStringField
      FieldName = 'PURPOSE'
      Origin = 'DB.KCLL.PURPOSE'
      FixedChar = True
      Size = 5
    end
  ...
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into KCLL'
        ...
        'ID, YN, SEASON, PURPOSE, DEVTYPE, MEMO, PMark)'
      'values'
      
        '  (:LLNO, :GSBH, :CKBH, :SCBH, :DepID, :USERDATE, :USERID, :CFMD' +
        'ate,:CFMID,:YN,:SEASON, :PURPOSE, :DEVTYPE ,:MEMO, :PMark)')
    DeleteSQL.Strings = (
      'delete from KCLL'
      'where'
      '  LLNO = :OLD_LLNO')
