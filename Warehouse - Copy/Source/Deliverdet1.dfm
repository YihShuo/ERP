object Deliverdet: TDeliverdet
  ...
  object KCLLQuery: TQuery
    ...
    object KCLLQueryARTICLE: TStringField
      FieldName = 'ARTICLE'
      FixedChar = True
    end
    object KCLLQueryKFJD: TStringField
      FieldName = 'KFJD'
      FixedChar = True
      Size = 3
    end
