...
begin
  ...
  begin
   ...
   SQL.Add('       KCRKScan_RFSS.Pack,KCRKScan_RFSS.Memo_RY,KCRKScan_RFSS.Memo_Article, KCZLS.KCBH, KCRKScan_RFSS.barcode,KCRKScan_RF.MEMO,KCRKScan_RF.DOCNO,KCRKScan_RFS.IDCheck ');
