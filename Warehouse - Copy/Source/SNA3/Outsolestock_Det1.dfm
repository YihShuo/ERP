object Outsolestock_Det: TOutsolestock_Det
  Left = 597
  Top = 373
  Width = 559
  Height = 295
  Caption = 'Outsolestock_Det'
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        Color = clBtnFace
        EditButtons = <>
        FieldName = 'OutsoleRem'
        Footers = <>
        Title.Caption = #26376#21021'|OutsoleRem'
        Width = 61
      end
      item
        Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      'select #CLZLKC_Outsole.*,CLZL.YWPM from #CLZLKC_Outsole'
      'left join CLZL on CLZL.CLDH=#CLZLKC_Outsole.CLBH '
      'where #CLZLKC_Outsole.CLBH=:CLBH'
      ' ')
    Left = 213
    Top = 96
    ParamData = <
    ...
    object Query1OutsoleRem: TFloatField
      FieldName = 'OutsoleRem'
    end
