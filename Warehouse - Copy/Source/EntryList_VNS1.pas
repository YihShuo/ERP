...
begin
 ...
 with query1 do
  begin
    ...
    sql.Add('       CLHG1.HGBH as HGBH1,CLHD1.HGBH as HGBH_HD1,CLTC1.HGBH as HGBH_TC1,CLNQ.HGBH as HGBH_NQ,CLNKNQ.HGBH as HGBH_NKNQ, KCZLS.CWBH  ');
    sql.add('from CGZLS');
    ...
    sql.add('CGZLS.USPrice,CGZLS.VNPrice,CGZLSS.ZLBH,CGRK.okQty,CLHG.HGBH,CLHD.HGBH,CLTC.HGBH,CLHG1.HGBH,CLHD1.HGBH,CLTC1.HGBH,CLNQ.HGBH,CLNKNQ.HGBH,KCZLS.CWBH');
    if checkbox1.Checked then
    sql.Add('      Having  isnull(sum(CGZLSS.qty),0)> isnull(CGRK.okQty,0) ');
    //
