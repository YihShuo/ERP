object LYV_LastborrowCFM: TLYV_LastborrowCFM
  ...
  object qryDelMas: TQuery
    ...
    SQL.Strings = (
        ...
        'select LTLL.*,BDepartment.DepName,LastKCCK.Memo as CKBH_Memo,Cas' +
        'e when LTLL.SFL='#39'1'#39' then '#39'Muon'#20511#20986#39' when LTLL.SFL='#39'2'#39' then '#39'BO PHE' +
        #22577#24290#39' end as SFL_DESC'
      'from LTLL '
      'left join BDepartment on LTLL.DepID=BDepartment.ID  '
      'left join LastKCCK on LastKCCK.CKBH=LTLL.CKBH'
    ...
    object qryDelMasCKBH_Memo: TStringField
      FieldName = 'CKBH_Memo'
      FixedChar = True
      Size = 50
    end
