...
procedure TLastSizeR_CL.FormCreate(Sender: TObject);
begin
  if Copy(LastSizeRange.SizeCombo.Text,1,2)='01' then EDIT1.Text:='VD';
  if Copy(LastSizeRange.SizeCombo.Text,1,2)='02' then EDIT1.Text:='VK';
  if Copy(LastSizeRange.SizeCombo.Text,1,2)='03' then EDIT1.Text:='V1';
  if Copy(LastSizeRange.SizeCombo.Text,1,2)='04' then EDIT1.Text:='VB';     
end;
