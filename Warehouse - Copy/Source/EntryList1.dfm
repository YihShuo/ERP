object EntryList: TEntryList
  ...
  object ENDet: TQuery
    ...
    SQL.Strings = (
        ...
        'select KCRKS.*,CLZL.YWPM,CLZL.DWBH,KCRKS.Qty as oldQty,CLZL_FLEX' +
        '.CLDHFLEX as FlexID  '
      'from KCRKS'
    ...
    object ENDetFlexID: TStringField
      FieldName = 'FlexID'
      FixedChar = True
      Size = 15
    end
  ...
  object PopupMenu1: TPopupMenu
    Left = 724
    Top = 357
    object SamebellowSTT1: TMenuItem
      Caption = 'Same bellow STT'
      OnClick = SamebellowSTT1Click
    end
  end
end
