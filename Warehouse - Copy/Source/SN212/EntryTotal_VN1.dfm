object EntryTotal_VN: TEntryTotal_VN
  Left = 214
  Top = 202
  Width = 1386
  Height = 451
  BorderIcons = [biSystemMenu]
  Caption = 'EntryTotal_VN'
  Color = clBtnFace
  ...
  object Query1: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select CGZLS.*,CGZL.ZSBH,CLZL.YWPM,CLZL.ZWPM,'
      
        '           CLZL.DWBH,KCZLS.KCBH,100.0 as okQty,CLHG.HGBH,CLHD.HG' +
        'BH as HGBH_HD,CLTC.HGBH as HGBH_TC,CLNKNQ.HGBH as HGBH_NKNQ, CGZ' +
        'LSS.ZLBH'
      'from CGZLS'
