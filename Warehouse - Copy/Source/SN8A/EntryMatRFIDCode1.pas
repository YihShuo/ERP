...
begin
  ...
  begin
    active:=false;
    sql.Clear;
    sql.Add('select KCRKScan_RFSSS.SCNO,KCRKScan_RFSS.CLBH, KCRKScan_RFSS.Pack, KCRKScan_RFSS.Qty, ROUND((sum(isnull(KCRKScan_RFSSS.Qty,0))),1) SQty from KCRKScan_RFSS ');
